@testset "CoverEnumerator" begin # FIXME use weights
    @testset "[:a] [:b] [:c] [:a :b :c], mask=[:a :b]" begin
        ...
        cover_etor1 = CoverEnumerator(sm_ab, CoverParams(sel_prob=1.0))
        ...
        cover_etor2 = CoverEnumerator(sm_ab, CoverParams(sel_prob=0.01))
        ...
        cover_etor3 = CoverEnumerator(sm_ab, CoverParams(sel_prob=1.0))
